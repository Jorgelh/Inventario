...
public class CONSULTAENTREGAS extends javax.swing.JInternalFrame {
   ...
   int a;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("MATERIAL ENTREGADO ");
    ...
    private void trabajosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_trabajosMouseClicked
         a = (int) (trabajos.getModel().getValueAt(trabajos.getSelectedRow(),8)); 
    ...
    private void listarproductospo(){
        ...
        ArrayList<Classp> result = consultas.ListarProductosPOentregados(a);
        productospo(result);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CONSULTAENTREGAS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CONSULTAENTREGAS().setVisible(true);
            }
        });
    }
