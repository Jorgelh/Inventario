 ...
 * @author Jorge Luis
 */
public class PrincipalInventario3 extends javax.swing.JFrame {

    /**
     * Creates new form PrincipalInventario
     */
    public PrincipalInventario3() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalInventario3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalInventario3().setVisible(true);
            }
        });
    }
