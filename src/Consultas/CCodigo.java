 ...
 * @author Jorge Luis
 */
public class CCodigo extends javax.swing.JInternalFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CCodigo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
