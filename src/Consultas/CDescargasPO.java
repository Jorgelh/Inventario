 ...
 * @author jluis
 */
public class CDescargasPO extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setTitle("CONSULTA DESCARGAS POR P.O.");
    ...
    private void DescKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DescKeyReleased
     ...
     private void actualizarTablaPO() {
        ...
        ArrayList<consultanp> result = BDConsultas.ListarDescargaPO(Desc.getText().toUpperCase());
        recagarTabla(result);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CDescargasPO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CDescargasPO().setVisible(true);
            }
        });
    }
