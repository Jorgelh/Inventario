...
public abstract class BDDescargaProducto {
    ...
    public static void insertarDescarga(Descarga ca)  throws SQLException{
        ...
        ps = cn.prepareStatement("insert into descarga(id_descarga,"
                                                     + "id_ingreso,"
                                                     + "codigo,"
                                                     + "cantidad,"
                                                     + "entregadoa,"
                                                     + "nota,fechades,fechasistema,documento,serie,lote,PN,no_trabajo,departamento,bodega,conta) values (DESCARGA1.nextval,?,?,?,?,?,?,sysdate,?,?,?,?,?,?,?,?)");
