 ...
 */
package ReportesKardex2;

import ReportesKardex2.*;
 ...
 * @author jluis
 */
public class ReportesDetalladosKardex2 extends javax.swing.JInternalFrame {
     ...
     */
    public ReportesDetalladosKardex2() {
         initComponents();
     ...
     public void reporteTotalMensual(){
       ...
       SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yy");
           ...
           /* String rutaReporte=System.getProperty("user.dir")+"/Reportes/SaldoMensual.jasper";
            ...
            JasperReport jasperReport=(JasperReport)JRLoader.loadObjectFromFile("SaldoMensualKardex2.jasper");
     ...
     public void reporteMensualDetallado(){
       ...
       SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yy");
            ...
            direccion.setText(rutaReporte);*/
            JasperReport jasperReport=(JasperReport)JRLoader.loadObjectFromFile("ReporteMasterKardex2.jasper");
            Map parametros= new HashMap();
...
if (inicio.getDate() != null && fin.getDate() != null) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportesDetalladosKardex2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportesDetalladosKardex2().setVisible(true);
            }
        });
    }
